public class ConfigKeys
{
    ...
    public const string ABILITY_COOLDOWN_KEY = "cooldown";
    public const string ABILITY_IS_PASSIVE_KEY = "isPassive";
    public const string ABILITY_IS_INTERRUPT_KEY = "isInterrupt";

    public const string DUNGEON_NAME_KEY = "name";
    public const string DUNGEON_ENEMY_TYPES_KEY = "enemyTypes";

    public const string ENEMY_TYPE_CHARACTER_KEY = "character";
    public const string ENEMY_TYPE_QUANTITY_KEY = "quantity";
}
